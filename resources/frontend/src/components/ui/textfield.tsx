...
type textFieldProps<T extends ValidComponent = 'div'> = TextFieldRootProps<T> & { class?: string }

export interface InputProps extends Omit<ComponentProps<'input'>, 'onChange' | 'ref' | 'value' | 'children'>, TextFieldRootProps {
...
export function Input(props: InputProps) {
    ...
    return (
        <TextFieldRoot onChange={handleChange} value={value()}>
...
function TextField<T extends ValidComponent = 'input'>(props: PolymorphicProps<T, textFieldInputProps<T>>) {
