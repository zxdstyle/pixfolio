...
export function Pagination<T extends ValidComponent = 'nav'>(props: PolymorphicProps<T, paginationProps<T>>) {
...
export function PaginationItem<T extends ValidComponent = 'button'>(props: PolymorphicProps<T, paginationItemProps<T>>) {
...
export function PaginationEllipsis<T extends ValidComponent = 'div'>(props: PolymorphicProps<T, paginationEllipsisProps<T>>) {
...
export function PaginationPrevious<T extends ValidComponent = 'button'>(props: PolymorphicProps<T, paginationPreviousProps<T>>) {
...
export function PaginationNext<T extends ValidComponent = 'button'>(props: PolymorphicProps<T, paginationNextProps<T>>) {
